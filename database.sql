...
INSERT INTO students (student_name, admission_year, major_code, individual_id, phone_number, address, gpa, credits_completed, enrollment_status)
VALUES 
    ('Kyle', 2022, 32, 11, '123-4567-8901', 'Washington DC, USA', 3.6, 110, TRUE),
    ('James', 2021, 2, 13, '456-7890-0123', 'Venice, Italy', 4.0, 65, FALSE),
    ('Layla', 2023, 32, 15, '123-0987-6543', 'Bangkok, Thailand', 3.7, 88, TRUE),
    ('Minji', 2024, 32, 22, '234-5643-9087', 'Seoul, Korea', 4.2, 125, TRUE);
